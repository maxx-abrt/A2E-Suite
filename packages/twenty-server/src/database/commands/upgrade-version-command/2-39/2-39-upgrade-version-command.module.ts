...
import { AddBundledAppSourcePathToApplicationRegistrationFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-39/2-39-instance-command-fast-1789905000000-add-bundled-app-source-path';
