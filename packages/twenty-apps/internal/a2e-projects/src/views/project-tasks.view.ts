...
export default defineView({
  ...
  fields: [
    {
      universalIdentifier: viewFieldId('01', 0, 0),
    ...
    {
      universalIdentifier: viewFieldId('01', 0, 1),
    ...
    {
      universalIdentifier: viewFieldId('01', 0, 2),
    ...
    {
      universalIdentifier: viewFieldId('01', 0, 3),
    ...
    {
      universalIdentifier: viewFieldId('01', 0, 4),
    ...
    {
      universalIdentifier: viewFieldId('01', 0, 5),
